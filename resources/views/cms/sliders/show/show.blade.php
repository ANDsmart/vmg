                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-right mb-2">
                                    <a href="{{ route('cms.slider.edit',$slider->uuid) }}" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i> {{ __('label.crud.edit') }}</a>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-striped table-bordered" id="">
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! ($slider->isactive)? trans('label.yes') : trans('label.no') !!}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td id="description">
                                                <img src="{{url($slider->image)}}" style="height: 30%"/>
                                            </td>
                                        </tr>
