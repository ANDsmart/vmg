...
<div class="row">
    <div class="col-12">
        ...
        {!! Form::select('service_type_cv_id',$service_types,$service->service_type_cv_id , ['placeholder' => __('label.title')  ,'id'=>'title', 'class' => 'form-control','required']) !!}
...
<div class="row">
    <div class="col-12">
        ...
        {!! Form::select('isactive',[1 =>'Yes',0=>'No', ],$service->isactve , ['id'=>'title', 'class' => 'form-control','required']) !!}
