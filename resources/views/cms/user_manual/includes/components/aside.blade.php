...
<aside class="doc_left_sidebarlist" >
    ...
    <div class="scroll">
        <ul class="list-unstyled nav-sidebar doc-nav" >
            ...
            <li class="nav-item">
                <a href="#module_group{{$module_group->id}}" class="nav-link" id="module_group" data-valuee="{{$module_group->id}}">{{$module_group->name}}</a>
                <ul class="list-unstyled dropdown_nav">
                    @foreach($module_group->modules as $module)
                    <li class="nav-item"><a href="#module{{$module->id}}" class="nav-link" id="module" data-valuee="{{$module->id}}">{{$module->name}}</a></li>
                     @endforeach
                </ul>
                <span class="icon">
                    <i class="icon_plus"></i>
