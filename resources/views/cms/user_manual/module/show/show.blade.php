...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12">
                    <a href="{{route('cms.user_manual.module.edit',$module->id)}}" class="pull-right"><i class="fa fa-pencil-alt"></i> </a>
                    {{$module->delete_button}}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                <label >{{ trans('label.name')}}:</label>
                                <label class="custom_label">{{ $module->name }}</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <label class="custom_label">{!! $module->description !!}</label>
                            </div>
                        </div>
                    </div>
                </div>
