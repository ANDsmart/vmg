...
@section('content')
    <div class="row">
        ...
        <div class="col-md-4">
            <a href="{{route('cms.user_manual.module_groups.create')}}" type="button" class="mb-1 mt-1 mr-1 btn btn-xs btn-primary pull-right">{{trans('label.cms.user_manual.new_module_group')}}</a>
        </div>
    </div>
    <div class="row">
...
{{--            @if($module_group->check_if_user_permitted)--}}
                <div class="col-md-4">
{{--                    <a href="{{route('cms.user_manual.module_groups.edit',$module_group->id)}}"><i class="fa fa-pencil"></i></a>--}}
