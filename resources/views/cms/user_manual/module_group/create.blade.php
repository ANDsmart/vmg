@extends('cms.layouts.cms', ['title' => trans('label.cms.user_manual.new_module_group'), 'header' => trans('label.cms.user_manual.new_module_group')])
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-body">
                    {{ Form::open(['route' => ['cms.user_manual.module_groups.store'], 'autocomplete' => 'off','method'=> 'Post', 'id' => 'store', 'class' => 'needs-validation', 'novalidate', 'enctype'=>"multipart/form-data"]) }}
                    ...
                    <div class="form-group mt-2">
                        {{ link_to_route('cms.user_manual.module_groups',trans('buttons.general.cancel'),[],['id'=> 'cancel', 'class' => 'btn btn-primary cancel_button', ]) }}
