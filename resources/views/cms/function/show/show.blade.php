                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-right mb-2">
                                    <a href="{{ route('cms.function.edit',$function->id) }}" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i> {{ __('label.crud.edit') }}</a>
                                    {{ $function->change_status_button }}

                                    <a class="btn btn-warning btn-xs   delete_blog"  style="text-decoration: none;cursor: pointer" id="{{$function->id}}">{{trans('label.crud.delete')}}</a>
                                    @if($function->status == 1)

                                        @else
                                    <a href="{{ route('cms.blog.publish',$function->id) }}" class="btn btn-xs btn-dark"><i class="fas fa-paper-plane"></i> {{ __('label.blog.publish') }}</a>
                                    @endif
                                ...
                                <div class="col-md-12">
                                    <table class="table table-striped table-bordered" id="">
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! isset($function->created_at)? short_date_format($function->created_at) : 'None' !!}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{!! trans('label.status') !!} :</b></td>
                                            <td>{!! ($function->status == 1)? trans('label.published') : trans('label.draft') !!}</td>
                                        </tr>
                                        <tr>
                                            <td><b>{!! trans('label.isactive') !!} :</b></td>
                                            <td>{!! ($function->isactive)? trans('label.yes') : trans('label.no') !!}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td id="description">{!! $function->description !!}</td>
                                        </tr>
                                        </tbody>
                                    </table>
