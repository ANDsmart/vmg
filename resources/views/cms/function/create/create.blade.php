...
@section("content")
    <div class="card">
        <div class="card-body">
            {!! Form::open(['route' => ['cms.function.store'],'method'=>'post', 'autocomplete' => 'off',  'id' =>'store_blog', 'class' => 'form-horizontal needs-validation', 'novalidate','enctype'=>"multipart/form-data"]) !!}
...
{{--                    <button type="button" class="mb-1 mt-1 mr-1 btn btn-primary btn-xs pull-right"><i class="fas fa-paper-plane"></i> {{trans('label.blog.publish')}}</button>--}}
            ...
            <div class="row">
                <div class="col-md-6">
                    @include('cms.function.create.includes.post_info')
