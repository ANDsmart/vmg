                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <ul class="dropdown-mega-sub-nav">
                                                                    <li><a class="dropdown-item" href="elements-accordions.html">Agriculture</a></li>
                                                                    <li><a class="dropdown-item" href="elements-toggles.html">Insights on Engineering, Construction & Building Materials
                                                                        </a></li>
                                                                    <li><a class="dropdown-item" href="elements-tabs.html">Insights on Financial Services
                                                                        </a></li>
                                                    ...
                                                    <div class="dropdown-mega-content">
                                                        <div class="row">
                                                            <div class="col-lg-4"><span class="dropdown-mega-sub-title" >We manage</span>
                                                                <ul class="dropdown-mega-sub-nav">
                                                                    @foreach((new \App\Repositories\System\CodeValueRepository())->getServiceForDirectory() as $code_value)
                                                                    <li><a class="dropdown-item" href="elements-accordions.html">{{$code_value->name}}</a></li>
