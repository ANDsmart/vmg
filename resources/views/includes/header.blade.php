                        ...
                        <div class="header-row">
                            <nav class="header-nav-top">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item dropdown nav-item-left-border d-none d-sm-block nav-item-left-border-remove nav-item-left-border-md-show"><a
                                                class="nav-link" href="#" role="button" id="dropdownLanguage" data-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false"> <img src="img/blank.gif" class="flag flag-us" alt="English"> English <i
                                                    class="fas fa-angle-down"></i> </a>
                                        <div class="dropdown-menu" aria-labelledby="dropdownLanguage"><a class="dropdown-item" href="#"><img src="img/blank.gif"
                                                                                                                                             class="flag flag-us"
                                                                                                                                             alt="English"> English</a> <a
                                                    class="dropdown-item" href="#"><img src="img/blank.gif" class="flag flag-es" alt="English"> Español</a> <a
                                                    class="dropdown-item" href="#"><img src="img/blank.gif" class="flag flag-fr" alt="English"> Française</a></div>
                                    </li>
                                    <li class="nav-item nav-item-left-border nav-item-left-border-remove nav-item-left-border-sm-show"><span class="ws-nowrap"><i
                                                    class="fas fa-phone"></i> (123) 456-789</span></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="header-row">
                <div class="header-column header-column-border-right flex-grow-0">
                    <div class="header-row pr-4">
                        <div class="header-logo" style="width: 100px; height: 48px;">
                            <a href="{{url('/')}}">
                                <img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" src="img/vmg.png"
                            ...
                            <div class="header-nav-main header-nav-main-square header-nav-main-font-lg-upper header-nav-main-effect-2 header-nav-main-sub-effect-1">
                                <nav class="collapse header-mobile-border-top">
                                    <ul class="nav nav-pills" id="mainNav">
                                        <li class="dropdown">
                                            <a class="dropdown-item dropdown-toggle active current-page-active" href="index-2.html"> Home <i
                                                        class="fas fa-chevron-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="index-2.html"> Landing Page </a></li>
                                                <li><a class="dropdown-item" href="index-2.html#demos"> Demos </a></li>
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Classic<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Corporate <span class="tip tip-dark">hot</span><i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Portfolio<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Blog<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">One Page<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown dropdown-mega"><a class="dropdown-item dropdown-toggle" href="elements.html"> Elements <i
                                                        class="fas fa-chevron-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li>
                                        ...
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#"> Features <i class="fas fa-chevron-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Headers<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Classic<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="feature-headers-classic.html">Classic</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-classic-language-dropdown.html">Classic + Language
                                                                        Dropdown</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-classic-big-logo.html">Classic + Big Logo</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Flat<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-headers-flat-top-bar-top-borders.html">Flat + Top Bar + Top
                                                                        Border</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-flat-colored-top-bar.html">Flat + Colored Top Bar</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-headers-flat-borders.html">Flat + Borders</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Center<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-headers-center-nav-buttons.html">Center + Nav + Buttons</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-headers-center-below-slider.html">Center Below Slider</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Floating<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Sticky<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Transparent<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-headers-transparent-light-bottom-border.html">Transparent Light
                                                                        + Bottom Border</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-transparent-dark-bottom-border.html">Transparent Dark +
                                                                        Bottom Border</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-transparent-bottom-slider.html">Transparent Bottom
                                                                        Slider</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-semi-transparent-light.html">Semi Transparent Light</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-headers-semi-transparent-dark.html">Semi Transparent Dark</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-headers-semi-transparent-bottom-slider.html">Semi Transparent
                                                                        Bottom Slider</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-semi-transparent-top-bar-borders.html">Semi Transparent
                                                                        + Top Bar + Borders</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Full Width<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-headers-full-width-transparent-light.html">Full Width
                                                                        Transparent Light</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-full-width-transparent-dark.html">Full Width
                                                                        Transparent Dark</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-full-width-semi-transparent-light.html">Full Width Semi
                                                                        Transparent Light</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-full-width-semi-transparent-dark.html">Full Width Semi
                                                                        Transparent Dark</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Navbar<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-headers-navbar-icons-search.html">Nav Bar + Icons + Search</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Side Header<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Side Header Left<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-left-dropdown.html">Dropdown</a>
                                                                        </li>
                                                                        ...
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-left-semi-transparent.html">Semi
                                                                                Transparent</a></li>
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-left-dark.html">Dark</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Side Header Right<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-right-dropdown.html">Dropdown</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-right-expand.html">Expand</a></li>
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-right-columns.html">Columns</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-right-slide.html">Slide</a></li>
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-right-semi-transparent.html">Semi
                                                                                Transparent</a></li>
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-right-dark.html">Dark</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Side Header Offcanvas<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-offcanvas-push.html">Push</a></li>
                                                                        <li><a class="dropdown-item" href="feature-headers-side-header-offcanvas-slide.html">Slide</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-headers-side-header-narrow-bar.html">Side Header Narrow Bar</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Search Styles<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="feature-headers-search-simple-input.html">Simple Input</a></li>
                                                                <li><a class="dropdown-item" href="feature-headers-search-simple-input-reveal.html">Simple Input
                                                                        Reveal</a></li>
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Extra<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Navigations<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Pills<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-navigations-pills-color-dropdown.html">Pills Color Dropdown</a>
                                                                </li>
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Stripes<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-navigations-stripe-color-dropdown.html">Stripe Color
                                                                        Dropdown</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Hover Effects<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="feature-navigations-hover-top-line.html">Top Line</a></li>
                                                                <li><a class="dropdown-item" href="feature-navigations-hover-top-line-animated.html">Top Line Animated</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-navigations-hover-top-line-color-dropdown.html">Top Line Color
                                                                        Dropdown</a></li>
                                                                <li><a class="dropdown-item" href="feature-navigations-hover-bottom-line.html">Bottom Line</a></li>
                                                                <li><a class="dropdown-item" href="feature-navigations-hover-bottom-line-animated.html">Bottom Line
                                                                        Animated</a></li>
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-navigations-hover-line-under-text.html">Line Under Text</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Vertical<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Hamburguer<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Dropdown Styles<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-navigations-dropdowns-arrow-center.html">Arrow Center
                                                                        Dropdown</a></li>
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Dropdown Effects<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-navigations-dropdowns-effect-move-to-top.html">Move To Top</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-navigations-dropdowns-effect-move-to-bottom.html">Move To
                                                                        Bottom</a></li>
                                                                <li><a class="dropdown-item" href="feature-navigations-dropdowns-effect-move-to-right.html">Move To
                                                                        Right</a></li>
                                                                <li><a class="dropdown-item" href="feature-navigations-dropdowns-effect-move-to-left.html">Move To
                                                                        Left</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Font Styles<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Icons<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Page Headers<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Modern<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Colors<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Title Position<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Left<i class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-page-headers-title-position-left-small.html">Small</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-page-headers-title-position-left-medium.html">Medium</a></li>
                                                                        <li><a class="dropdown-item" href="feature-page-headers-title-position-left-large.html">Large</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Right<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-page-headers-title-position-right-small.html">Small</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-page-headers-title-position-right-medium.html">Medium</a></li>
                                                                        <li><a class="dropdown-item" href="feature-page-headers-title-position-right-large.html">Large</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Center<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-page-headers-title-position-center-small.html">Small</a></li>
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-page-headers-title-position-center-medium.html">Medium</a></li>
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-page-headers-title-position-center-large.html">Large</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Background<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-page-headers-background-transparent-header.html">Transparent
                                                                        Header</a></li>
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-page-headers-background-clean.html">Clean (No Background)</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Extra<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Breadcrumb<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-page-headers-extra-breadcrumb-outside.html">Outside</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-page-headers-extra-breadcrumb-dark.html">Dark</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li><a class="dropdown-item" href="feature-page-headers-extra-scroll-to-content.html">Scroll to
                                                                        Content</a></li>
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Footers<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Classic<i
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Copyright<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-footers-classic-copyright-light.html#footer">Light</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-footers-classic-copyright-dark.html#footer">Dark</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-footers-classic-copyright-social-icons.html#footer">Social
                                                                                Icons</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Colors<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-footers-classic-colors-primary.html#footer">Primary</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-footers-classic-colors-secondary.html#footer">Secondary</a></li>
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-footers-classic-colors-tertiary.html#footer">Tertiary</a></li>
                                                                        <li><a class="dropdown-item"
                                                                               href="feature-footers-classic-colors-quaternary.html#footer			">Quaternary</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-footers-classic-colors-light.html#footer">Light</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-footers-classic-colors-light-simple.html#footer">Light
                                                                                Simple</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Modern<i
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="feature-footers-modern-font-style-alternative.html#footer">Font Style
                                                                        Alternative</a></li>
                                                                ...
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Background<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-footers-modern-background-image-simple.html#footer">Image
                                                                                Simple</a></li>
                                                                        <li><a class="dropdown-item" href="feature-footers-modern-background-image-advanced.html#footer">Image
                                                                                Advanced</a></li>
                                                                        <li><a class="dropdown-item" href="feature-footers-modern-background-video-simple.html#footer">Video
                                                                                Simple</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Call to Action<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-footers-modern-call-to-action-button.html#footer">Button</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="feature-footers-modern-call-to-action-simple.html#footer">Simple</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Blog<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="feature-footers-blog-classic.html#footer">Blog Classic</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">eCommerce<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="feature-footers-ecommerce-classic.html#footer">eCommerce Classic</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Contact Form<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="feature-footers-contact-form-classic.html#footer">Classic</a></li>
                                                                <li><a class="dropdown-item" href="feature-footers-contact-form-above-the-map.html#footer">Above the
                                                                        Map</a></li>
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Map<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Extra<i
                                                                        class="fas fa-chevron-down"></i></a>
                                                            <ul class="dropdown-menu">
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Simple<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-footers-extra-top-social-icons.html#footer">Top Social
                                                                                Icons</a></li>
                                                                ...
                                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Full Width<i
                                                                                class="fas fa-chevron-down"></i></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="feature-footers-extra-full-width-light.html#footer">Simple
                                                                                Light</a></li>
                                                                        <li><a class="dropdown-item" href="feature-footers-extra-full-width-dark.html#footer">Simple
                                                                                Dark</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Admin Extension <span class="tip tip-dark">hot</span><em
                                                                class="not-included">(Not Included)</em><i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Sliders<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Layout Options<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Extra<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#"> Pages <i class="fas fa-chevron-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Contact Us<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">About Us<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Layouts<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Team<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu"><a class="dropdown-item" href="#">Services<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#"> Portfolio <i class="fas fa-chevron-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Single Project<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Grid Layouts<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item" href="portfolio-grid-1-column-title-and-description.html">Title and Description</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Masonry Layouts<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Sidebar Layouts<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Ajax<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#"> Blog <i class="fas fa-chevron-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Large Image<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Medium Image<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Grid<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Masonry<i class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Timeline<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Single Post<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Post Comments<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown dropdown-reverse"><a class="dropdown-item dropdown-toggle" href="#"> Shop <i class="fas fa-chevron-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">Single Product<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">3 Columns<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">2 Columns<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu dropdown-reverse"><a class="dropdown-item" href="#">1 Column<i
                                                                class="fas fa-chevron-down"></i></a>
                                                    <ul class="dropdown-menu">
                ...
                <div class="header-nav-features header-nav-features-no-border p-static z-index-2">
                    ...
                    <div class="header-nav-feature header-nav-features-search header-nav-features-search-reveal header-nav-features-search-reveal-big-search px-3">
                        <form role="search" class="d-flex w-100 h-100" action="https://preview.oklerthemes.com/porto/8.0.0/page-search-results.html" method="get">
