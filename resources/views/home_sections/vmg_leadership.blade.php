<section class=" custom-section-padding-2" style="background-color: #88bad3">
    ...
    <div class="owl-carousel show-nav-title custom-both-sides-shadow custom-dots-position-2 custom-dots-style-1 custom-xs-arrows-style-2 mb-0 owl-theme owl-loaded owl-drag owl-carousel-init" data-plugin-options="{'items': 6, 'loop': false, 'dots': true, 'nav': false}" style="height: auto;">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2072px;"><div class="owl-item active" style="width: 230.167px;"><div>
                    ...
                    </div></div><div class="owl-item active" style="width: 230.167px;"><div>
                        <a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
                        ...
                        <a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/demos/business-consulting/cases/case-5.jpg" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption  p-4 pt-5 pb-5" style="background-color: #88bad3">
										<span class="custom-thumb-info-title">
                    ...
                    </div></div><div class="owl-item" style="width: 230.167px;"><div>
                        <a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/demos/business-consulting/cases/case-2.jpg" class="img-fluid" alt="">
                    ...
                    </div></div></div></div><div class="owl-nav disabled"><button type="button" role="presentation" class="owl-prev"></button><button type="button" role="presentation" class="owl-next"></button></div><div class="owl-dots"><button role="button" class="owl-dot active"><span></span></button><button role="button" class="owl-dot"><span></span></button></div></div>
</section>
